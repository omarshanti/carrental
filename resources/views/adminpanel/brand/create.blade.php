         ...
         @endif
          ...
          <div class="widget-content widget-content-area" >
              <div class="table-responsive" >
                <form method="post" action="{{route('admin.brand.create.post')}}">
                        @csrf
                        <div class="form-group">
                          <input type="text" class="form-control" name="brandName" placeholder="{{__('Brand Name In English')}}">
                        </div>
                        <div class="form-group">
                            <input type="text" class="form-control" name="brandName_ar" placeholder="{{__('Brand Name In Arabic')}}">
                          </div>
