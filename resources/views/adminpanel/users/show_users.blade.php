        ...
        <div class="row layout-top-spacing" id="cancel-row">
            <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
                <div class="widget-content widget-content-area br-6">
                    ...
                    <br>
                    <a href="{{route('admin.users.create')}}" class="btn btn-success mb-2 mr-2 btn-rounded">Create User</a>
                            ...
                            <tbody>
                              @foreach($data as $user)
                                <tr>
                                    ...
                                    <td class="text-center"><span class="badge badge-success">{{__('Enabled')}}</span>
                                    @else
                                    <td class="text-center"><span class="badge badge-danger">{{__('Disabled')}}</span>
                                    @endif
                                    <td class="text-center"><span class="badge badge-success">{{$user->roles}}</span>
                                    <td>{{"Roles"}}</td> 
                                    <td>{{$user->created_at}}</td>
                                    <td class="text-center"  style="display: flex; margin-top: 15px;">
                                        
                                   {{--  @if($user->id !== Auth::user()->id)  --}}
                                      <li style="list-style-type: none;"><a href="{{route('admin.users.edit',['user' => $user->id])}}" data-toggle="tooltip" data-placement="top" title="" data-original-title="Make Admin"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-check-circle text-primary"><path d="M22 11.08V12a10 10 0 1 1-5.93-9.14"></path><polyline points="22 4 12 14.01 9 11.01"></polyline></svg></a></li>
                                        <li style="list-style-type: none;"><a href="{{route('admin.users.destroy',['user' => $user->id])}}" data-toggle="tooltip" data-placement="top" title="" data-original-title="Delete"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-trash-2 text-danger"><polyline points="3 6 5 6 21 6"></polyline><path d="M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6m3 0V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"></path><line x1="10" y1="11" x2="10" y2="17"></line><line x1="14" y1="11" x2="14" y2="17"></line></svg></a></li>
                                   {{--  @endif  --}}
                                </td>
                                    </td>
                                </tr>
