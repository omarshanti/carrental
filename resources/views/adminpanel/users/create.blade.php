                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12">
                        <div class="form-group">
                            ...
                            <select class="selectpicker" name="status">
                                <option value="Enabled" data-content="<span class='badge badge-primary' style='margin-left:15px'>Enable</span>">Enable</option>
                                <option value="Disabled" data-content="<span class='badge badge-danger' style='margin-left:15px'>Disable</span>">Disable</option>
                            </select>
                        </div>
                    </div>
